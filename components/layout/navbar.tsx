  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? 'bg-base-100/90 shadow-lg shadow-base-content/5 backdrop-blur-xl'
          : 'bg-base-100/80 backdrop-blur-sm'
      )}
    >
      <div className="navbar container mx-auto max-w-7xl gap-4 px-4 min-h-16">
        ...
        <div className="navbar-start">
          ...
          <Link href="/" className="flex items-center gap-2">
            {logoUrl ? (
              <motion.div
                {...animationProps}
                className="relative h-9 md:h-10 w-auto max-w-[180px]"
              >
                <img
                  src={logoUrl}
                  alt={siteName}
        ...
        {/* RIGHT */}
        <div className="navbar-end gap-2 sm:gap-3 items-center">
          ...
          <Link
            href="/offer"
            className="btn btn-primary btn-xs sm:btn-sm rounded-xl shrink-0 shadow-sm hover:shadow gap-1.5"
          >
            {t('getQuote')}
          </Link>
          ...
          <Link
            href="/login"
            className="hidden sm:flex btn btn-outline btn-sm rounded-xl shrink-0 gap-1.5 border-base-300"
          >
            <LogIn className="w-4 h-4 shrink-0" />
