...
export default async function WhatWeDoPage() {
  ...
  const serviceCardsRes = await fetch(`${base}/api/service-cards?published=true`, { cache: 'no-store' });
  const serviceCards =
    (serviceCardsRes.ok ? await safeJson<ServiceCard[]>(serviceCardsRes) : null) ?? [];
